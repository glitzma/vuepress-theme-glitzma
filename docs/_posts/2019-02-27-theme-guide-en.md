...
::: tip
If you have any questions / ideas about this theme, feel free to open issues / PRs in the [Github Repo](https://github.com/glitzma/vuepress-theme-glitzma).
...
Install `vuepress` and `vuepress-theme-glitzma`, remember to add `next` tag to install the `1.x` version:
...
module.exports = {
  ...
  themeConfig: {
    ...
    lang: require('vuepress-theme-glitzma/lib/langs/en-US'),
    ...
    personalInfo: {
      ...
      avatar: 'https://www.glitzma.cn/assets/img/avatar.jpg',
...
> You can check the [languages directory](https://github.com/glitzma/vuepress-theme-glitzma/tree/master/lib/langs) for all supported languages
...
module.exports = {
  themeConfig: {
    lang: Object.assign(require('vuepress-theme-glitzma/lib/langs/en-US'), {
